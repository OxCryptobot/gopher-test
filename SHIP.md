...
30. [x] Static tests — chrome nav search/tasks/waitlist/play, SUG_MAX 3, mascot on home hero, manifest name, sw cache gopher-v11 (includes dig.js + tasks.json), game exports, maze strings (fox, Huzaaa, Clunk, Ouchies, TIME OVER, GOPHER CHAMPION), dig.js exists and exports DigGame, 404, `server.py` compile, prompt `#suggest`
